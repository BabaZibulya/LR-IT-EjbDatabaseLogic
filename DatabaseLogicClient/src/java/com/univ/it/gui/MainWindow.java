...
import com.univ.it.server.DatabaseLogicBeanRemote;
...
public class MainWindow extends Application {
    ...
    @EJB
    private static DatabaseLogicBeanRemote databaseLogicBean;
    ...
    private void createTable() {
        ...
        createNewTableButton.setOnAction(e -> {
            ...
            if (!tableNameTextField.getText().equals("")) {
                ...
                try {
                    databaseLogicBean.addTable(newTable);
                } catch (Exception ex) {
    ...
    private void showDataBase() {
        ...
        try{
            tables = databaseLogicBean.getTables();
        } catch (Exception e) {
            showErrorMessage(e.getMessage());
    ...
    private void dropTable() {
        ...
        try {
            if (!databaseLogicBean.dropTable(tabName)) {
    ...
    private void addNewRowTable() {
        ...
        try {
            ...
            table = databaseLogicBean.getTable(tableName);
        } catch (Exception e) {
            showErrorMessage("No current table");
            return;
        }
        ...
        addButton.setOnAction(e -> {
            ...
            try {
                databaseLogicBean.addRow(tableName, row);
            } catch (Exception ex) {
                showErrorMessage(ex.toString());
            }
            newWindow.close();
    ...
    private void calculateDifference() {
        ...
        try {
            allTableNames = databaseLogicBean.getTables().keySet();
        } catch (Exception e) {
            showErrorMessage(e.getMessage());
            return;
        }
        ...
        calculateDifference.setOnAction(e -> {
            ...
            try {
                databaseLogicBean.addTable(
                        Table.differenceBetween(
                                databaseLogicBean.getTable(firstTableName),
                                databaseLogicBean.getTable(secondTableName)
                        )
                );
            } catch (Exception e1) {
